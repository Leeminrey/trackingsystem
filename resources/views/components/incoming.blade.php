    ...
    <div class="table-data">
        <div class="order">
            ...
            <table id="documentsTable">
                ...
                @if($document->uploaded_from === 'incoming')  {{-- Filter documents with 'incoming' in the 'uploaded_from' column --}}
                @if(auth()->user()->usertype === 'admin') {{-- Show both pending statuses --}}
                    ...
                    @elseif(auth()->user()->role === 'receiving')
                        @if($document->status === 'pending' || $document->status === 'pending in CL') {{-- Show both pending statuses --}}
                    ...
                    @elseif(auth()->user()->role === 'ACL') {{-- Check if the logged-in user is Boss 2 --}}
                        ...
                        @endif
                    @elseif(auth()->user()->usertype === 'section') {{-- Check if the logged-in user is a section user --}}
